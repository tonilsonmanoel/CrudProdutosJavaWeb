    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
             Produto u = new Produto();//criando o objeto do tipo entidade para setar o valores de retorno
            u.setCodigo(Integer.valueOf(request.getParameter("codigo")));
            ManterProduto dao = new ManterProduto();//criando o objeto do tipo dao para executar o metodo pesquisar
            u=dao.pesquisar(u);
            request.setAttribute("uCodigo", u.getCodigo());
            request.setAttribute("uNome",u.getNome());
            request.setAttribute("uPreco",u.getPreco());
            request.setAttribute("uCategoria", u.getCategoria());
             request.setAttribute("uQuantidade", u.getQuantidade());
